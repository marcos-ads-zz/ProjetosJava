...
public final class JifFaturamento extends javax.swing.JInternalFrame {
    ...
    public List<Faturamento> CalcularValores() throws Exception {
        ...
        jTotalPendenciasCTF.setText(fun.convertDoubleToStringMoeda(valorctf));
        jTotalFaturamento.setText(fun.convertDoubleToStringMoeda(v_fita - (v_faturas + v_cd)));
        ...
        jTotalCreditoDigital.setText(fun.convertDoubleToStringMoeda(v_cd));
        jTotalCupomVip.setText(fun.convertDoubleToStringMoeda(v_cupomv));
        //jTotalDePopular.setText();
        jTotalDescontoVip.setText(fun.convertDoubleToStringMoeda(v_dv));
        jTotalDevolucao.setText(fun.convertDoubleToStringMoeda(v_devol));
        jTotalFatura.setText(fun.convertDoubleToStringMoeda(v_faturas));
        jTotalItensVendidos.setText(Integer.toString(itens));
        jTotaldeTrocasValor.setText(fun.convertDoubleToStringMoeda(v_trocas));
        ...
        fat.forEach((a) -> {
            try {
                modelo.addRow(new Object[]{
                    ...
                    fun.convertDoubleToStringMoeda(a.getValor_fita()),
                    a.getQtd_cli_geral(),
                    a.getQtd_itens_vendidos(),
                    fun.convertDoubleToStringMoeda(a.getValor_credito_digital()),
                    a.getQtd_cli_credito(),
                    fun.convertDoubleToStringMoeda(a.getValor_faturas()),
                    a.getQtd_cli_fatura(),
                    fun.convertDoubleToStringMoeda(a.getValor_devolucoes()),
                    a.getQtd_devolucao(),
                    fun.convertDoubleToStringMoeda(a.getValor_trocas()),
                    a.getQtd_trocas(),
                    fun.convertDoubleToStringMoeda(a.getValor_cupom_vip()),
                    fun.convertDoubleToStringMoeda(a.getValor_desc_vip()),
                    fun.convertDoubleToStringMoeda(a.getValor_venda_caixa()),
                    a.getQtd_cli_caixa()
                });
            } catch (Exception ex) {
