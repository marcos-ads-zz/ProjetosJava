...
import modulo.contas.AguaDAO;
import modulo.contas.Energia;
import modulo.contas.EnergiaDAO;
import modulo.faceamento.ListaDeRuptura;
import modulo.faceamento.ListaDeRupturaDAO;
import modulo.inventario.Inventario;
import modulo.inventario.InventarioDAO;
...
public final class Dashboard extends javax.swing.JInternalFrame {
    ...
    private int nume = 10;
    private String anoVigenteInv, anoVigenteContas;
    private List<Inventario> inventario;
    private List<Agua> agua;
    private List<Energia> energia;
    ...
    public void TabelaRegistrosDoDia() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Erro TabelaRegistrosDoDia! " + ex.getMessage());
        }
    }

    public List<ListaDeRupturaP> TabelaTop15() {
        ListaDeRupturaP objRup;
        List<ListaDeRupturaP> lista = new ArrayList<>();
        int cont = 0;
        try {
            for (Object p : DAOLISTA.SelectOrdenaCodigo()) {
                cont++;
                objRup = new ListaDeRupturaP();
                objRup.setId(cont);
                objRup.setCod_interno(fun.convertToInt(p.toString()));
                objRup.setDescricao(DAOPro.PesquisarPorCodInterno(Integer.parseInt(p.toString())).getDescricao());
                objRup.setQtd_perdida(DAOLISTA.SelectOrdenaQuantidade(fun.convertToInt(p.toString())));
                lista.add(objRup);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Erro TabelaTop15! " + ex.getMessage());
        }
        return lista;
    }
    ...
    public void TabelaTop15MaisSolicitados() {
        ...
        modelo.setNumRows(0);
        List<ListaDeRupturaP> lista = TabelaTop15();
        lista.forEach((p) -> {
            modelo.addRow(new Object[]{
                p.getId(), p.getCod_interno(), p.getDescricao(),
                p.getQtd_perdida()
            });
        });
    }
    ...
    public void TabelaRegistrosPorMatricula() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Erro TabelaRegistrosPorMatricula! " + ex.getMessage());
        }
    }
...
//***********************************************Inventario*************************************************
    ...
    public String CarregaAnoInventario() {
        int ano = jYearChooserInvent.getYear();
        anoVigenteInv = Integer.toString(ano);
        return anoVigenteInv;
    }

    public void CarregaDadosInventario() throws Exception {
        InventarioDAO inv = new InventarioDAO();
        inventario = inv.TabelaPesquisaPorAno(CarregaAnoInventario());
        CarregaGrafInv();
    }

    public void painelInventario_1() throws PropertyVetoException, Exception {
        jPanelBarraIMA.removeAll();
        jPanelBarraIMA.add(new ChartPanel(dg.painelGraficoBarraInventarioIMA(inventario, anoVigenteInv)), BorderLayout.CENTER);
        jPanelBarraIMA.validate();
    }

    public void painelInventario_2() throws PropertyVetoException {
        jPanelBarraTotalProdutos.removeAll();
        jPanelBarraTotalProdutos.add(new ChartPanel(dg.painelGraficoBarraInventarioTotalPro(inventario, anoVigenteInv)), BorderLayout.CENTER);
        jPanelBarraTotalProdutos.validate();
    }

    public void painelInventario_3() throws PropertyVetoException {
        jPanelBarraFalta.removeAll();
        jPanelBarraFalta.add(new ChartPanel(dg.painelGraficoBarraInventarioFaltas(inventario, anoVigenteInv)), BorderLayout.CENTER);
        jPanelBarraFalta.validate();
    }

    public void painelInventario_4() throws PropertyVetoException {
        jPanelBarraSobra.removeAll();
        jPanelBarraSobra.add(new ChartPanel(dg.painelGraficoBarraInventarioSobra(inventario, anoVigenteInv)), BorderLayout.CENTER);
        jPanelBarraSobra.validate();
    }
//***********************************************Contas da Loja*********************************************

    public Double CarregaAnoContas() {
        int ano = jYearChooserContas.getYear();
        anoVigenteContas = Integer.toString(ano);
        Double result = fun.convertToDouble(anoVigenteContas);
        return result;
    }

    public void CarregaDadosContas() throws Exception {
        EnergiaDAO ener = new EnergiaDAO();
        AguaDAO agu = new AguaDAO();
        energia = ener.TabelaPesquisaPorAno(CarregaAnoContas());
        agua = agu.TabelaPesquisaPorAno(CarregaAnoContas());
        CarregaGrafContas();
    }

    public void painelContas_1() throws PropertyVetoException {
        jPanelBarraContasEnergValor.removeAll();
        jPanelBarraContasEnergValor.add(new ChartPanel(dg.painelGraficoBarraEnergValor(energia, anoVigenteContas)), BorderLayout.CENTER);
    ...
    public void painelContas_2() throws PropertyVetoException {
        ...
        jPanelBarraContasEnergConsumo.add(new ChartPanel(dg.painelGraficoBarraEnergConsumo(energia, anoVigenteContas)), BorderLayout.CENTER);
    ...
    public void painelContas_3() throws PropertyVetoException {
        ...
        jPanelBarraContasAguaValor.add(new ChartPanel(dg.painelGraficoBarraAguaValor(agua, anoVigenteContas)), BorderLayout.CENTER);
    ...
    public void painelContas_4() throws PropertyVetoException {
        ...
        jPanelBarraContasAguaConsumo.add(new ChartPanel(dg.painelGraficoBarraAguaConsumo(agua, anoVigenteContas)), BorderLayout.CENTER);
...
//***********************************************Lista de Faltas********************************************
    ...
    public void painelGraficoRuptura() throws PropertyVetoException, Exception {
        ...
        jPanelGraficoRuptura.removeAll();
        jPanelGraficoRuptura.add(new ChartPanel(dg.painelGraficoRuptura(anoVigente)), BorderLayout.CENTER);
        jPanelGraficoRuptura.validate();
    }
    ...
    private void initComponents() {
        ...
        jBAtualizarInv = new javax.swing.JButton();
        jYearChooserInvent = new com.toedter.calendar.JYearChooser();
        jLabelInvent = new javax.swing.JLabel();
        ...
        jYearChooserContas = new com.toedter.calendar.JYearChooser();
        jBAtualizarContas = new javax.swing.JButton();
        jLabelInvent1 = new javax.swing.JLabel();
        ...
        jBAtualizarInv.setBackground(new java.awt.Color(255, 0, 51));
        jBAtualizarInv.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jBAtualizarInv.setForeground(new java.awt.Color(255, 255, 0));
        jBAtualizarInv.setText("ATUALIZA");
        jBAtualizarInv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBAtualizarInvActionPerformed(evt);
            }
        });

        jLabelInvent.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabelInvent.setText("SELECIONE O ANO VIGENTE");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup()
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabelInvent, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jYearChooserInvent, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBAtualizarInv))
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel13Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jPanelBarraSobra, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel13Layout.createSequentialGroup()
                                .addComponent(jPanelBarraIMA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jPanelBarraTotalProdutos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                .addGap(29, 29, 29))
        );
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jYearChooserInvent, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelInvent, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jBAtualizarInv))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanelBarraIMA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanelBarraContasEnergValor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelBarraContasEnergValorMouseClicked(evt);
            }
        });
        ...
        jBAtualizarContas.setBackground(new java.awt.Color(255, 0, 51));
        jBAtualizarContas.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jBAtualizarContas.setForeground(new java.awt.Color(255, 255, 0));
        jBAtualizarContas.setText("ATUALIZA");
        jBAtualizarContas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBAtualizarContasActionPerformed(evt);
            }
        });

        jLabelInvent1.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabelInvent1.setText("SELECIONE O ANO VIGENTE");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGap(280, 971, Short.MAX_VALUE)
                        .addComponent(jLabelInvent1, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jYearChooserContas, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBAtualizarContas))
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addComponent(jPanelBarraContasAguaValor, javax.swing.GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jPanelBarraContasAguaConsumo, javax.swing.GroupLayout.DEFAULT_SIZE, 662, Short.MAX_VALUE))
                            .addGroup(jPanel12Layout.createSequentialGroup()
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jYearChooserContas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelInvent1, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jBAtualizarContas))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jPanelBarraContasEnergValorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelBarraContasEnergValorMouseClicked
        JOptionPane.showMessageDialog(this, "MouseClik: ");
    }//GEN-LAST:event_jPanelBarraContasEnergValorMouseClicked

    private void jBAtualizarInvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAtualizarInvActionPerformed
        try {
            CarregaDadosInventario();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Erro! Feche o Painel e Tente Novamente:/n Descrição do Erro " + ex.getMessage());
        }

    }//GEN-LAST:event_jBAtualizarInvActionPerformed

    private void jBAtualizarContasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAtualizarContasActionPerformed
        try {
            CarregaDadosContas();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Erro! Feche o Painel e Tente Novamente:/n Descrição do Erro " + ex.getMessage());
        }
    }//GEN-LAST:event_jBAtualizarContasActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jBAtualizar;
    private javax.swing.JButton jBAtualizarContas;
    private javax.swing.JButton jBAtualizarInv;
    ...
    private javax.swing.JLabel jLabelInvent;
    private javax.swing.JLabel jLabelInvent1;
    ...
    private com.toedter.calendar.JYearChooser jYearChooserContas;
    private com.toedter.calendar.JYearChooser jYearChooserInvent;
