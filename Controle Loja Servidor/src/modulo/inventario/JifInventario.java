...
public final class JifInventario extends javax.swing.JInternalFrame {
    ...
    public JifInventario() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Erro Listar Dados: " + ex.getMessage());
        }
    }
    ...
    public void HabilitaTudo() {
        ...
        jbListarItens.setText("Listar Todos");
        habilita = true;
    }
    ...
    public void DesabilitaTudo() {
        ...
        jbListarItens.setText("Pesquisar Por Ano");
        habilita = false;
    }
    ...
    public void ListarTodos() throws Exception {
        ...
        jfAno.setText(ano);
        inventario = DAOINV.TabelaPesquisaTodos();
        ListaPesquisaAno(inventario);
    }

    public void ListarPorAno() throws Exception {
        List<Inventario> inventario;
        String ano = jfAno.getText();
    ...
    public void CarregaDados() {
        if (jTabela.getRowCount() >= 1) {
            if (jTabela.getSelectedRow() != -1) {
                ...
                jbEditar.setText("Editar Dados");
                jbEditar.setBackground(Color.yellow);
            }
        }
    }
        ...
        inventario.forEach((p) -> {
            try {
                modelo.addRow(new Object[]{
                    ...
                    p.getValor_ima(),
                    fun.convertDoubleToStringMoeda(p.getValor_venda_estoque()),
                    fun.convertDoubleToStringMoeda(p.getValor_venda_falta()),
                    fun.convertDoubleToStringMoeda(p.getValor_venda_sobra()),
                    fun.convertDoubleToStringMoeda(p.getValor_custo_estoque()),
                    fun.convertDoubleToStringMoeda(p.getValor_custo_falta()),
                    fun.convertDoubleToStringMoeda(p.getValor_custo_sobra()),
                    p.getPrazo(),
    ...
    private void initComponents() {
        ...
        jbListarItens = new javax.swing.JButton();
        ...
        jbListarItens.setText("Listar Todos");
        jbListarItens.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbListarItensActionPerformed(evt);
            }
        });
    ...
    private void jbListarItensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbListarItensActionPerformed
        try {
            if (habilita) {
                ListarTodos();
            } else {
    ...
    }//GEN-LAST:event_jbListarItensActionPerformed
    ...
    private javax.swing.JButton jbListarItens;
