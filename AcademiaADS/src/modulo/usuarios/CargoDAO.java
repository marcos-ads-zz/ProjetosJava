...
public class CargoDAO {
    ...
    public boolean Insert(Cargos objFun) throws Exception {
        con = new Conexao();
        String SQL = "insert into "+dados.getBD()+"."+dados.getSCHE()+".cargos("
                + "descricao, "
                + "nivel) values (?,?)";
    ...
    public boolean Update(Cargos objFun) throws Exception {
        con = new Conexao();
        String SQL = "UPDATE "+dados.getBD()+"."+dados.getSCHE()+".cargos set "
                + "descricao = ?, "
    ...
    public boolean Delete(int id) throws Exception {
        con = new Conexao();
        String SQL = "DELETE from "+dados.getBD()+"."+dados.getSCHE()+".cargos where id_cargo = ?";
        PreparedStatement ps = con.getCONEXAO().prepareStatement(SQL);
        ps.setInt(1, id);
    ...
    public List<Cargos> PesquisaNome(String nome) throws Exception {
        ...
        String SQL = "select * from "+dados.getBD()+"."+dados.getSCHE()+".cargos where descricao like ?";
        PreparedStatement ps = con.getCONEXAO().prepareStatement(SQL);
    ...
    public List<Cargos> Pesquisa() throws Exception {
        ...
        Cargos objCargo = null;
        List<Cargos> cargos = new ArrayList<>();
        String SQL = "select * from "+dados.getBD()+"."+dados.getSCHE()+".cargos";
        PreparedStatement ps = con.getCONEXAO().prepareStatement(SQL);
        ResultSet rs = ps.executeQuery();
        while (rs.next()) {
            objCargo = new Cargos();
