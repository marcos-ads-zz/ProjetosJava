...
public final class JifControleDeContas extends javax.swing.JInternalFrame {
    ...
    public void ListarAuto() throws Exception {
        ...
        switch (num) {
            case 0:
                energia = DAOENERG.TabelaPesquisaPorAno(fun.anoAtualDate());
                ListaPesquisaAnoEnergia(energia);
                break;
            case 1:
                agua = DAOAGUA.TabelaPesquisaPorAno(fun.anoAtualDate());
        ...
        switch (num) {
            case 0:
                if (!jfCodigo.getText().equals("")) {
                    energia = DAOENERG.TabelaPesquisaPorAno(ano);
                    ListaPesquisaAnoEnergia(energia);
                }
                break;
            case 1:
                if (!jfCodigo1.getText().equals("")) {
                    agua = DAOAGUA.TabelaPesquisaPorAno(ano);
                    ListaPesquisaAnoAgua(agua);
                }
                break;
            default:
    ...
    public boolean PreencheDadosSalvar() throws ParseException {
        ...
        switch (num) {
            case 0:
                ...
                objEnergia.setDate_vendimento(fun.convertDateStringToDateSQL(jfDataVencimento.getText()));
                objEnergia.setValor_conta(fun.convertToDouble(jfValorTotal.getText()));
                objEnergia.setConsumno(Integer.parseInt(jfConsumoKWH.getText()));
            ...
            case 1:
                ...
                objAgua.setDate_vendimento(fun.convertDateStringToDateSQL(jfDataVencimento1.getText()));
                objAgua.setValor_conta(fun.convertToDouble(jfValorTotal1.getText()));
                objAgua.setConsumno(Integer.parseInt(jfConsumo.getText()));
        ...
        energ.forEach((p) -> {
            try {
                modelo.addRow(new Object[]{
                    ...
                    fun.convertDataSQLToDateString(p.getDate_vendimento()),
                    fun.convertDoubleToString(p.getValor_conta()),
                    p.getConsumno(), p.getAno()
    ...
    private void initComponents() {
        ...
        jTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CÓDIGO", "NOTA FISCAL", "EMISSÃO", "VENCIMENTO", "VALOR", "CONSUMO", "ANO"
            }
        ) {
