 ...
 */
public class JfAjuda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("No entanto, caso você tenha muitas células com esse problema, você pode utilizar a função Editar > Localizar e substituir:\n\n1º no campo Pesquisar por coloque ^.\n2º no campo Substituir por coloque &\n3º clique no botão Mais opções e marque a opção Expressões regulares\n4º clique no botão Substituir todos para, então, eliminar os apóstrofos em todas as células da planilha.\n\nAo eliminar os apóstrofos das células com valores numéricos, \nos cálculos passarão a considerar esses valores. \nComo no nosso exemplo inicial, agora corrigido:\n\nDica: uma maneira fácil e visual de identificarmos valores numéricos com o apóstrofo é a função Exibir > Realce de valor. Ao utilizá-la:\nos números serão apresentados em azul (inclusive datas);\nos textos serão apresentados em preto;\nas fórmulas serão apresentadas em verde.\nCaso você encontre valores numéricos apresentados em preto, \né provável que a interpretação esteja sendo feita como texto através do apóstrofo na primeira posição da célula.");
